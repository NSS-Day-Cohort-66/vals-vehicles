...
from vehicles.water import JetSki
...
sea_doo = JetSki(8, "Sea-Doo RXP-X 325", "Super fun", "Neon Blue")
vue_doo = JetSki(8, "Vue-Doo LKW-X 300", "Super fun", "Neon Blue")
...
lake_tappan = Dock("Lake Tappan", "Cadiz, OH", 25, 40, 8, 10)
lake_tappan.add_vehicle(sea_doo)
lake_tappan.add_vehicle(vue_doo)
